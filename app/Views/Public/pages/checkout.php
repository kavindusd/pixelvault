      ...
      <div class="flex flex-col lg:flex-row gap-12 text-left">
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <label class="relative flex items-center gap-4 p-5 rounded-2xl border-2 border-border bg-card cursor-pointer hover:border-primary/50 transition-all has-[:checked]:border-primary has-[:checked]:bg-primary/5">
                  <input type="radio" name="payment_method" value="PayPal" class="sr-only peer" checked>
                  <div class="h-10 w-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-600"><?= icon_svg('CreditCard', 'h-5 w-5') ?></div>
        ...
        <script>
          document.querySelector('form[action="/checkout/process"]').addEventListener('submit', function(e) {
            ...
            portalLogo.innerHTML = method === 'PayPal' 
              ? `<div class="text-4xl font-display font-black italic text-blue-700">Pay<span class="text-blue-500">Pal</span></div>`
              : `<div class="text-4xl font-display font-black text-emerald-600">Pay<span class="text-emerald-400">here</span></div>`;
