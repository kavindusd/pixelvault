...
$router->addRoute('POST', '/admin/add-payment-method', [ManagementController::class, 'addAdminPayment']);
$router->addRoute('POST', '/admin/update-payment-method', [ManagementController::class, 'updateAdminPayment']);
$router->addRoute('POST', '/admin/delete-payment-method', [ManagementController::class, 'deleteAdminPayment']);
